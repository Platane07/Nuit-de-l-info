...
<head>
  ...
  <title> EtuAssist </title>

  <!-- Custom fonts for this themse -->
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="index.html">ETU-ASSIST</a>
 ...
 <!-- Masthead -->
  <header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
      ...
      <!-- Masthead Heading -->
      <h1 class="masthead-heading text-uppercase mb-0">Navigation</h1><br></br>

 <div class="divider-custom divider-light align-items-left">
...
xhr.send();
      ...
      <div class="divider-custom divider-light align-items-left">
        ...
        <div class="divider-custom-line align-item-left"></div>
      </div>

      <!-- Masthead Subheading -->
      <p class="masthead-subheading font-weight-light mb-0">Assistance pour étudiant précarisé</p>
  ...
  <footer class="footer text-center">
    <div class="container">
      <div class="row">
        ...
        <!-- Footer Social Icons -->
        <div class="col-lg-4 mb-5 mb-lg-0">
          <h4 class="text-uppercase mb-4">Liens réseaux sociaux</h4>
        ...
        <!-- Footer About Text -->
        <div class="col-lg-4">
          <h4 class="text-uppercase mb-4">TEAM ITTOQQORTOMITT</h4>
          <p class="lead mb-0">Jolan-Bastien-Etienne</br>Yannis-Nicolas-Salvatore</br>Florian-Enzo
